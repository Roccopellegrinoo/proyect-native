    ...
    render() {
      return (
        <View style={styles.contenedor}>
          <View style={{ display: 'flex', flexDirection: 'row' }}> {/* Contenedor datos perfil */}
            <View style={{ borderRadius: '50%' }}> {/* Contenedor datos foto perfil */}
              <Image
                source={{ uri: 'https://picsum.photos/200/300' }}
                style={{ width: 150, height: 150, borderRadius: 100 }}
              />
            </View>
            <View style={{ display: 'flex', flexDirection: 'column', marginLeft: 50, justifyContent: 'center' }}> {/* Contenedor información del perfil */}
